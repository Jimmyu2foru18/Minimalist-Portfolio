            ...
            <div className="lg:col-span-3 space-y-6 sm:space-y-8">
              ...
              <div className="space-y-6 max-w-md">
                <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                  Full-Stack Software Engineer & Systems Developer building
                  <span className="text-foreground"> scalable applications</span> through composition and
                  <span className="text-foreground"> well-designed algorithms</span>. Passionate about
                  <span className="text-foreground"> composable foundations</span> that scale.
                </p>
            ...
            <div className="lg:col-span-2 flex flex-col justify-end space-y-6 sm:space-y-8 mt-8 lg:mt-0">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {["TypeScript", "React", "Node.js", "Python", "PostgreSQL", "Docker"].map((skill) => (
                    <span
                      key={skill}
            ...
            <div className="space-y-8">
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  ...
                  My interest started with hardware—taking apart old Microsoft computers in the early 2000s—and evolved
                  toward software as I learned how things were built in college.{" "}
                  <span className="text-foreground">Building computers and making software from scratch</span> became an
                  educational hobby I genuinely enjoy.
                </p>

                <p className="text-lg text-muted-foreground leading-relaxed">
                  I only want to build things right—
                  <span className="text-foreground">solid architecture, clean abstractions, no cutting corners</span>. I
                  focus on creating things with a strong foundation so the core of all projects are solid and can be
                  built upon further. I concentrate on{" "}
                  <span className="text-foreground">composable foundations that scale</span> and let things grow from
                  there.
                </p>

                <p className="text-lg text-muted-foreground leading-relaxed">
                  Currently pursuing a degree in Mathematics Education at SUNY Old Westbury while working as a
                  Mathematics and CIS tutor. My certifications in{" "}
        ...
        <section id="projects" ref={(el) => { sectionsRef.current[2] = el }} className="py-16 sm:py-24">
          <div className="space-y-12 sm:space-y-16">
            ...
            <div className="grid gap-6 sm:gap-8 lg:grid-cols-2">
              {[
                {
                  title: "PookiesPlaytime",
                  description:
                    "Interactive gaming platform with modern UI/UX patterns and sophisticated state management for seamless user experiences.",
                  tech: ["TypeScript", "React", "State Management"],
                  url: "https://pookiesplaytime.vercel.app",
                ...
                },
                {
                  ...
                  description:
                    "Enterprise-grade scalable architecture implementation with microservices patterns demonstrating advanced system design principles.",
                  tech: ["TypeScript", "React", "Microservices"],
                  url: "https://system-design-project.vercel.app",
                  category: "Systems",
                  status: "LIVE",
                },
                {
                  title: "Periodic Table WebApp",
                  description:
                    "Interactive scientific data visualization with dynamic element rendering, transitions, and comprehensive chemical information display.",
                  tech: ["JavaScript", "CSS3", "Data Viz"],
                  url: "https://github.com/Jimmyu2foru18/Periodic-Table-WebApp",
                  category: "Education",
                  status: "CODE",
                },
                {
                  ...
                  description:
                    "Interactive pathfinding visualization engine with dynamic grid-based simulation showcasing algorithm efficiency and path optimization.",
                ...
                {
                  title: "Register Management System",
                  description:
                    "Enterprise inventory control system with user authentication and demo deployment for comprehensive business management.",
                  tech: ["TypeScript", "Node.js", "Auth"],
                  url: "https://github.com/Jimmyu2foru18/Register-Management-System",
                  category: "Enterprise",
                  status: "CODE",
                },
                {
                  ...
                  description:
                    "Turn-based combat engine showcasing game architecture and state machine patterns built with Godot Engine.",
                  tech: ["GDScript", "Godot", "Game Dev"],
                  url: "https://github.com/Jimmyu2foru18/Creature-Battle-Arena",
                  category: "Games",
                  status: "CODE",
                },
                {
                  title: "Mini Discord",
                  description:
                    "Real-time messaging application prototype with WebSocket implementation for instant communication features.",
                  tech: ["TypeScript", "WebSocket", "Real-time"],
                  url: "https://github.com/Jimmyu2foru18/Mini-Discord",
                ...
                },
                {
                  title: "CarrotQuest",
                  description:
                    "Physics-based platformer with character control systems, collision detection, and progressive difficulty scaling.",
                  tech: ["JavaScript", "Physics", "HTML5"],
        ...
        <section id="skills" ref={(el) => { sectionsRef.current[6] = el }} className="py-16 sm:py-24">
          <div className="space-y-12 sm:space-y-16">
              ...
              {[
                {
                  ...
                  excerpt:
                    "Java, Python, JavaScript, TypeScript, C#, C++, Rust, GDScript, Lua, R, and BASIC. Self-learning Haskell and functional programming paradigms for expanded problem-solving approaches.",
                  category: "Languages",
                ...
                },
                {
                  ...
                  excerpt:
                    "HTML5, CSS3, React, Vue.js, Node.js, Express.js, PHP, Ruby on Rails, and Laravel. Building scalable, production-ready full-stack applications with modern frameworks.",
                  category: "Full-Stack",
                ...
                },
                {
                  ...
                  excerpt:
                    "MySQL, PostgreSQL, MongoDB, and Redis for data persistence. Linux, Git, AWS, and Docker for deployment and infrastructure management.",
                ...
                },
                {
                  ...
                  excerpt:
                    "Composition over inheritance. DRY principle—automate redundancy, abstract patterns. Documentation-first: what you did, what you're doing, what you're going TODO. If it's hard to test, it's poorly designed.",
                  category: "Principles",
            ...
            <div className="space-y-6">
              <h3 className="text-xl font-light">Current Technical Focus</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  { domain: "Database Architecture", tech: "SQL, PostgreSQL, Redis", status: "Active" },
                  { domain: "Full-Stack Development", tech: "TypeScript, React, Node.js", status: "Active" },
                  { domain: "Algorithm Design", tech: "Graph Theory, Pathfinding", status: "Growing" },
                  { domain: "Systems Design", tech: "Microservices, Distributed", status: "Active" },
                  { domain: "Game Development", tech: "Godot Engine, GDScript", status: "Learning" },
                  { domain: "Functional Programming", tech: "Haskell, C, Make", status: "Self-Learning" },
                ].map((focus) => (
                  <div key={focus.domain} className="p-4 border border-border rounded-lg space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-foreground">{focus.domain}</span>
                      <span className="text-xs text-muted-foreground">{focus.status}</span>
                    </div>
                    <span className="text-xs text-muted-foreground">{focus.tech}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section id="connect" ref={(el) => { sectionsRef.current[7] = el }} className="py-16 sm:py-24">
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16">
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-6">
                <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                  Open to collaborations and actively seeking full-stack roles. Passionate about building scalable
                  applications with solid architecture and clean abstractions. Always interested in meaningful
                  conversations about technology, education, and innovative problem-solving.
                </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  },
                  {
                    name: "Discord",
                    handle: "Join Server",
                    url: "https://discord.gg/zRKJj65KBE",
                  },
                ].map((social) => (
                  <a
                    key={social.name}
